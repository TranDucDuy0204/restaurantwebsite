...
<body>
        ...
        <form action="#" class="order">
            <fieldset class="order-food">
                ...
                <div class="food-menu-img">
                    <img src="./images/menu-pizza.jpg" alt="Chicken Pizza" class="img-responsive img-curve order-img">
                </div>
            ...
            <fieldset class="order-food">
                ...
                <input type="text" name="full-name" placeholder="E.g Duc Duy" class="input-responsive" require>

                <div class="order-label">Phone Number</div>
                <input type="tel" name="contact" placeholder="E.g 0356xxxxx" class="input-responsive" require>

                <div class="order-label">Email</div>
                <input type="email" name="email" placeholder="E.g tranducduy0204@gmail.com" class="input-responsive" require>
    ...
    <section class="footer">
        <div class="container text-center">
           <p>All rights resserved. Designed by <a href="#">Duy</a></p>
        </div>
    </section>
